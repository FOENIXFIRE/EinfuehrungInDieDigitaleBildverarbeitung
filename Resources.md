...
# Links and resources:
The resources are grouped by the person that used them. All resources
were last used on the 7th january 2021.
...
* Sources:
    ...
    * [Optical flow for motion estimation in video](https://de.mathworks.com/discovery/optical-flow.html)
...
### Jan Koenig
* Sources:
    * [Grey2Binary](https://blogs.mathworks.com/steve/2016/06/14/image-binarization-otsus-method/?from=jp)
    * [Grey2Canny](https://de.mathworks.com/matlabcentral/fileexchange/46859-canny-edge-detection)
    * [Grey2Sobel](https://www.geeksforgeeks.org/matlab-image-edge-detection-using-sobel-operator-from-scratch/)
    * [Grey2Sobel3](https://www.geeksforgeeks.org/matlab-image-edge-detection-using-sobel-operator-from-scratch/)
